...
public class visaoSalaEstudo extends javax.swing.JFrame {
    ...
    private void jTSalaEstudoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTSalaEstudoMouseClicked
        if(jTSalaEstudo.getSelectedRow() != -1){
            ...
            jTxtArea.setText((String) tableModel.getValueAt(jTSalaEstudo.getSelectedRow(), 1).toString());
        }
...
//            Espaco e = new Espaco(jTxtNome.getText(), Float.parseFloat(jTxtArea.getText()));
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        if(jTSalaEstudo.getSelectedRow() != -1){
            ...
            tableModel.setValueAt(jTxtArea.getText(), jTSalaEstudo.getSelectedRow(), 1);
        }
