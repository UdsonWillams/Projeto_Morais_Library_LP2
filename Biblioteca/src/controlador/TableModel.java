...
public class TableModel extends AbstractTableModel {
    ...
    private final static int VINCULO_INDEX = 3;
    private final static int TELEFONE_INDEX = 4;
    private final static int EMAIL_INDEX = 5;
    private final static int ENDERECO_INDEX = 6;
    private final static int CIDADE_INDEX = 7;
    private final static int CURSO_INDEX = 8;

   private ArrayList<Usuario> dados;
   private final String[] colunas = {"NOME", "CPF", "GÊNERO","VINCULO", "CELULAR", "EMAIL", "ENDEREÇO", "CIDADE", "CURSO"};
